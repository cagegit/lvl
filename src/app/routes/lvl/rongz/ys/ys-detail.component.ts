...
@Component({
  selector: 'app-ys-detail',
  templateUrl: './ys-detail.component.html',
})
export class YsDetailComponent implements OnInit {
    ...
    ngOnInit() {
        this.activatedRoute.queryParams.subscribe(queryParams => {
            ...
            if (queryParams && queryParams.dcsn) {
                ...
                this.lvService.yfszDetail(queryParams.dcsn).subscribe(res => {
