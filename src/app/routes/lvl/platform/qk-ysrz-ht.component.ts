...
@Component({
  selector: 'app-qk-ysrz-ht',
  templateUrl: './qk-ysrz-ht.component.html',
})
export class QkYsrzHtComponent implements OnInit {
    ...
    getData() {
        this.loading = true;
        this.lvService.getYsrzData(this.currentStatus)
