...
@Component({
  selector: 'app-qk-wallet',
  templateUrl: './qk-wallet.component.html',
})
export class QkWalletComponent implements OnInit {
    payType = PayType;
    data = [];
    loading = false;
    totalYe = 0;
    ...
    constructor(private lvService: LvService) { }
