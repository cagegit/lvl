...
@Component({
  selector: 'app-ys-hkgl',
  templateUrl: './ys-hkgl.component.html',
    styles: [`
    .hk-head {
...
export class YsHkglComponent implements OnInit {
    ...
    getData() {
        ...
        this.lvService.getZfYfrz(param)
            .pipe(
