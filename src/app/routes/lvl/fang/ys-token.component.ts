...
@Component({
  selector: 'app-ys-token',
  templateUrl: './ys-token.component.html',
    styles: [`
    .hk-head {
...
export class YsTokenComponent implements OnInit {
    ...
    ngOnInit() {
        this.activatedRoute.queryParams.subscribe(queryParams => {
            ...
            if (queryParams && queryParams.pfcsn) {
                ...
                this.lvService.getYsToken(queryParams.pfcsn).subscribe(res => {
    ...
    * */
    congfirmYsZf() {
        ...
        this.loading = true;
        this.lvService.ysTokenZhang(pfcsn, params)
            .pipe(
